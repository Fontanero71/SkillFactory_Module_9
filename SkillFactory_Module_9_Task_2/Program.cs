...
namespace SkillFactory_Module_9_Task_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            string[] listOfNames = new string[5]; //= { "Иванов", "Петров", "Сидоров", "Балабанов", "Герасимов" };
        ...
        {
            string[] list = new string[] { "Балабанов", "Герасимов", "Иванов", "Петров", "Сидоров"};
            return list;
        }
        public static string[] SortZ_A()
        {
            string[] list = new string[] { "Сидоров", "Петров", "Иванов", "Герасимов", "Балабанов"};
            return list;
        }
